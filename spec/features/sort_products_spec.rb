...
RSpec.feature "SortProducts", type: :feature do
  ...
  scenario "visit clicks on Sort by Alphabetical" do
    product1 = FactoryGirl.create(:product, name: "Brad's Hat",image_path: "https://crowdsourcedtesting.com/resources/wp-content/uploads/2015/06/The-Parts-of-a-Usability-Test-Plan-300x225.jpg") # similar to Product.create, but with some default values
    product2 = FactoryGirl.create(:product, name: "Adam's Hat",image_path: "https://crowdsourcedtesting.com/resources/wp-content/uploads/2015/06/The-Parts-of-a-Usability-Test-Plan-300x225.jpg")
